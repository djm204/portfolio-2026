/**
 * Cloudflare Pages Function: Read Content Override (Generic)
 ...
 * Uses content: prefix (different from case-study: prefix)
...
export async function onRequestGet(context: {
  ...
  try {
    ...
    // Use content: prefix (different from case-study: prefix)
